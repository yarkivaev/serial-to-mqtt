...
class KsumDelimiterPartialMessageBuffers(unittest.TestCase):
    """
    Tests that KsumDelimiter buffers partial message without next marker.
    """
...
class KsumDelimiterCompleteMessageExtracts(unittest.TestCase):
    """
    Tests that KsumDelimiter extracts complete message with next marker.
    """
...
class KsumDelimiterPartialChecksumBuffers(unittest.TestCase):
    """
    Tests that KsumDelimiter buffers partial checksum without next marker.
    """
